...
#include "Survival/Items/Globals/ItemHelpers.h"
#ifdef _MSC_VER
#pragma warning (push)
#pragma warning (disable : 4883)
#endif
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeItemHelpers() {}
// Cross Module References
	...
	SURVIVAL_API UClass* Z_Construct_UClass_UItemHelpers_NoRegister();
	SURVIVAL_API UClass* Z_Construct_UClass_UItemHelpers();
...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Survival_EItemType_CRC() { return 3497556208U; }
	UEnum* Z_Construct_UEnum_Survival_EItemType()
	{
		...
		if (!ReturnEnum)
		{
			...
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				{ "BlueprintType", "true" },
				{ "ModuleRelativePath", "Items/Globals/ItemHelpers.h" },
...
static struct FScriptStruct_Survival_StaticRegisterNativesFItemProperties
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FItemProperties_CRC() { return 4119918459U; }
	void UItemHelpers::StaticRegisterNativesUItemHelpers()
	{
	}
	UClass* Z_Construct_UClass_UItemHelpers_NoRegister()
	{
		return UItemHelpers::StaticClass();
	}
	struct Z_Construct_UClass_UItemHelpers_Statics
	{
	...
	UObject* (*const Z_Construct_UClass_UItemHelpers_Statics::DependentSingletons[])() = {
		(UObject* (*)())Z_Construct_UClass_UObject,
		(UObject* (*)())Z_Construct_UPackage__Script_Survival,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UItemHelpers_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "Items/Globals/ItemHelpers.h" },
		{ "ModuleRelativePath", "Items/Globals/ItemHelpers.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UItemHelpers_Statics::StaticCppClassTypeInfo = {
		TCppClassTypeTraits<UItemHelpers>::IsAbstract,
	};
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UItemHelpers_Statics::ClassParams = {
		&UItemHelpers::StaticClass,
		...
		nullptr, 0,
		METADATA_PARAMS(Z_Construct_UClass_UItemHelpers_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UItemHelpers_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UItemHelpers()
	{
		static UClass* OuterClass = nullptr;
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UItemHelpers_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UItemHelpers, 2757831041);
	static FCompiledInDefer Z_CompiledInDefer_UClass_UItemHelpers(Z_Construct_UClass_UItemHelpers, &UItemHelpers::StaticClass, TEXT("/Script/Survival"), TEXT("UItemHelpers"), false, nullptr, nullptr, nullptr);
	DEFINE_VTABLE_PTR_HELPER_CTOR(UItemHelpers);
